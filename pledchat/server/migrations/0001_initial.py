# Generated by Django 5.1 on 2024-11-17 04:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.ImageField(blank=True, null=True, upload_to=server.models.server_icon_upload_path, validators=[server.validators.validate_image_file_extension, server.validators.validate_icon_image_size])),
